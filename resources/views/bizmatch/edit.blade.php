    ...
    <div class="min-h-screen bg-white ">
        ...
        <div class="bg-white sm:p-8">
            <div class="container mx-auto pt-6 gap-6 flex w-full relative justify-center" x-data="{ openSection: 1, modalSubmit: false, modalBack: false, addressSame: false }">
                <form action="{{ route('bizmatch.update', $bizmatch->id) }}" method="POST" enctype="multipart/form-data" class="form">
                @csrf
                        ...
                        <div class="mb-4 p-4 rounded-xl shadow border-color-75 bg-white flex flex-col gap-6">
                            ...
                            <div class="flex justify-between mb-4 flex-wrap">
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="partner_event" required placeholder="Masukkan Nama Partner Event"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="region_scope" required placeholder="Masukkan Region/Scope"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <select id="country" name="country"
                                        ...
                                        <option value="{{ $bizmatch->country }}" selected>{{ $bizmatch->country }}</option>
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <select id="city" name="city"
                                        ...
                                        <option value="{{ $bizmatch->city }}" selected>{{ $bizmatch->city }}</option>
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="business_sector" required placeholder="Masukkan Sektor Perusahaan"
                                        autocomplete="off"
                        ...
                        <div class="mb-4 p-4 mt-8 rounded-xl shadow border-color-75 bg-white flex flex-col gap-6">
                            ...
                            <div class="flex justify-between mb-4 flex-wrap">
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="product_category" required placeholder="Masukkan Kategori Produk"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="umkm_name" required placeholder="Masukkan Nama UMKM"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="buyer_name" required placeholder="Masukkan Nama Buyer"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="progress" required placeholder="Masukkan Progress"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="result" required placeholder="Masukkan Hasil"
                                        autocomplete="off"
