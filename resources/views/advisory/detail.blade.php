    ...
    <div class="min-h-screen bg-white ">
        ...
        <div class="bg-white sm:p-8">
            <div class="container mx-auto pt-6 gap-6 flex w-full relative justify-center" x-data="{ openSection: 1, modalSubmit: false, modalBack: false, addressSame: false }">
                <form action="{{ route('advisory.store') }}" method="POST" enctype="multipart/form-data" class="form">
                @csrf
                ...
                <div class="form-container">
                    ...
                    <div x-show="openSection === 1" class="transition-all duration-300 ease-in-out transform"
                        ...
                        <div class="mb-4 p-4 rounded-xl shadow border-color-75 bg-white flex flex-col gap-6">
                            <div class="text-tosca text-base font-semibold leading-normal text-center">Data Advisory</div>
                            <div class="flex justify-between mb-4 flex-wrap">
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    ID Advisory <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="proposal_no" required placeholder="Masukkan No. Usulan" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $advisory->id }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                        Tanggal Pelatihan <span class="text-red-400">*</span>
                                    </label>
                                    <input type="date" name="training_date" required disabled
                                        ...
                                        placeholder="DD/MM/YYYY" value="{{ $advisory->training_date }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    No. Usulan <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="proposal_no" required placeholder="Masukkan No. Usulan" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $advisory->proposal_no }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    PIC Xpora <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="pic_name" required placeholder="Masukkan Nama PIC" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $advisory->pic_name }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    Nama Pelatihan <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="training_name" required placeholder="Masukkan Nama Pelatihan" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $advisory->training_name }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    Deskripsi Pelatihan <span class="text-red-400">*</span>
                                    </label>
                                    <textarea type="text" name="training_description" required placeholder="Masukkan Deskripsi Pelatihan" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" />{{ $advisory->training_description }}</textarea>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    Partner Internal <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="internal_partner" required placeholder="Masukkan Partner Internal" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $advisory->internal_partner }}"/>
                                </div> 
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    Nama Pengajar <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="instructor_name" required placeholder="Masukkan Nama Pengajar" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $advisory->instructor_name }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    ...
                                    <select id="province" name="province" disabled
                                        ...
                                        <option value="{{ $advisory->province }}" disabled selected>{{ $advisory->province }}</option>
                                    </select>
                                </div>  
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    ...
                                    <select id="city" name="city" disabled
                                        ...
                                        <option value="{{ $advisory->city }}" disabled selected>{{ $advisory->city }}</option>
                                    </select>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    Jenis Pelatihan <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="training_type" required placeholder="Masukkan Jenis Pelatihan" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $advisory->training_type }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    Level Pelatihan <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="training_level" required placeholder="Masukkan Level Pelatihan" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $advisory->training_level }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    ...
                                    <div style="display: flex; align-items: center; border: 1px solid #d1d5db; border-radius: 0.375rem;">
                                        <input id="participantInput" type="number" value="{{ $advisory->participant_count }}" min="0" name="participant_count" disabled
                                            style="border: none; outline: none; text-align: center; flex-grow: 1; padding: 0.5rem; font-size: 1rem;" 
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="proposed_budget" disabled
                                            class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full pl-11"
                                            required placeholder="00" value="{{ $advisory->proposed_budget }}"/>
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="budget_type" required placeholder="Masukkan Jenis Budget" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $advisory->budget_type }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    Dokumen Advisory <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="advisory_document" required placeholder="Masukkan Link Dokumen" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $advisory->advisory_document }}"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex justify-end gap-5 p-6 button-container">
                    <button type="button" @click="modalBack = true"
                        ...
                        <button type="button" onclick="window.location.href='/dashboard/advisory/{{ $advisory->id }}/edit'"
