    ...
    <div class="min-h-screen bg-white ">
        ...
        <div class="bg-white sm:p-8">
            <div class="container mx-auto pt-6 gap-6 flex w-full relative justify-center" x-data="{ openSection: 1, modalSubmit: false, modalBack: false, addressSame: false }">
                <form action="{{ route('advisory.update', $advisory->id) }}" method="POST" enctype="multipart/form-data" class="form">
                @csrf
                        ...
                        <div class="mb-4 p-4 rounded-xl shadow border-color-75 bg-white flex flex-col gap-6">
                            ...
                            <div class="flex justify-between mb-4 flex-wrap">
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="proposal_no" required placeholder="Masukkan No. Usulan"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="pic_name" required placeholder="Masukkan Nama PIC"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="training_name" required placeholder="Masukkan Nama Pelatihan"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <textarea type="text" name="training_description" required placeholder="Masukkan Deskripsi Pelatihan"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="internal_partner" required placeholder="Masukkan Partner Internal"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="instructor_name" required placeholder="Masukkan Nama Pengajar"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <select id="province" name="province"
                                        ...
                                        <option value="{{ $advisory->province }}" selected>{{ $advisory->province }}</option>
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <select id="city" name="city"
                                        ...
                                        <option value="{{ $advisory->city }}" selected>{{ $advisory->city }}</option>
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="training_type" required placeholder="Masukkan Jenis Pelatihan"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="training_level" required placeholder="Masukkan Level Pelatihan"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <div style="display: flex; align-items: center; border: 1px solid #d1d5db; border-radius: 0.375rem;">
                                        <a onclick="decreaseValue()" style="border: none; background: silver; padding: 0.5rem; cursor: pointer;"><</a>
                                        <input id="participantInput" type="number" value="{{ $advisory->participant_count }}" min="0" name="participant_count"
                                            style="border: none; outline: none; text-align: center; flex-grow: 1; padding: 0.5rem; font-size: 1rem;" 
                                            placeholder="Masukkan Jumlah Peserta" />
                                        <a onclick="increaseValue()" style="border: none; background: silver; padding: 0.5rem; cursor: pointer;">></a>
                                    </div>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="advisory_document" required placeholder="Masukkan Link Dokumen"
                                        autocomplete="off"
