    ...
    <div class="min-h-screen bg-white ">
        ...
        <div class="bg-white sm:p-8">
            <div class="container mx-auto pt-6 gap-6 flex w-full relative justify-center" x-data="{ openSection: 1, modalSubmit: false, modalBack: false, addressSame: false }">
                <form action="{{ route('release.update',$release->id) }}" method="POST" enctype="multipart/form-data" class="form">
                @csrf
                            ...
                            <div class="flex justify-between mb-4 flex-wrap">
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="event_category" required placeholder="Masukkan kategori publikasi"
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $release->event_category }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    ...
                                    <input type="text" name="bizmatch_event_name" required placeholder="Masukkan Nama Publikasi"
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $release->bizmatch_event_name }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    Nama Media Massa <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="media_name" required placeholder="Masukkan Nama Media Massa"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="news_link" required placeholder="Masukkan Link Berita"
                                        autocomplete="off"
