<x-cataprint-layout title="Catalogue {{ $umkm->badan_usaha }}. {{ $umkm->nama_perusahaan }}">
    <div style="width: 1088px" class=" mx-auto bg-white mt-10 overflow-hidden relative flex">
        ...
        <div class="flex-auto bg-catalouge !bg-pink-900">
            ...
            <div class="grid mr-5 mt-7 gap-7 ml-24">
                <div class="text-5xl text-white playfair-display font-bold h-28 flex items-end">{{ $umkm->badan_usaha }}. {{ $umkm->nama_perusahaan }}</div>
                ...
                <div style="top: 920; left: -272;" class="absolute rotate-90 flex w-full items-center -ml-56 mt-56">
                    <div style="margin-right: -150px"
                        class="text-twine-200 text-3xl font-semibold tracking-widest uppercase z-20 bg-tobacco-brown-700">{{ $umkm->kategori_perusahaan }}</div>
        ...
        <div class="flex-auto w-4/12 bg-white py-4 p-7">
            ...
            <div class="grid mt-28">
                ...
                <div class=" text-neutral-900 text-5xl font-bold playfair-display">{{ $umkm->nama_brand }}</div>
            </div>
            ...
            <div class="flex mt-5">
                ...
                <div class="ml-2">
                    <div class=" text-neutral-900 text-sm font-bold">NERAGA TUJUAN EXPOR</div>
                    <div class="flex">
                    ...
                    <div class="flex">
                        <ul class="list-disc text-sm ml-5">
                            @if($umkm->omzet_export_1)
                                <li>{{ $umkm->omzet_export_1 }}</li>
                            @endif
                            @if($umkm->omzet_export_2)
                                <li>{{ $umkm->omzet_export_2 }}</li>
                            @endif
                            @if($umkm->omzet_export_3)
                                <li>{{ $umkm->omzet_export_3 }}</li>
                            @endif
                            @if($umkm->omzet_export_4)
                                <li>{{ $umkm->omzet_export_4 }}</li>
                            @endif
                            @if($umkm->omzet_export_5)
                                <li>{{ $umkm->omzet_export_5 }}</li>
                            @endif
                        </ul>
                    </div>
                </div>
