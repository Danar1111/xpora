    ...
    <div class="min-h-screen bg-white ">
        ...
        <div class="bg-white sm:p-8">
            <div class="container mx-auto pt-6 gap-6 flex w-full relative justify-center" x-data="{ openSection: 1, modalSubmit: false, modalBack: false, addressSame: false }">
                <form action="{{ route('marcom.update', $marcom->id) }}" method="POST" enctype="multipart/form-data" class="form">
                @csrf
                        ...
                        <div class="mb-4 p-4 rounded-xl shadow border-color-75 bg-white flex flex-col gap-6">
                            ...
                            <div class="flex justify-between mb-4 flex-wrap">
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="date" name="marcom_date" required
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="video_link" placeholder="Masukkan Link Video"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="picture_link" required placeholder="Masukkan Link Picture"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="content_category" required placeholder="Masukkan Media Placement"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="allocation" required placeholder="Masukkan Campaign Owner"
                                        autocomplete="off"
