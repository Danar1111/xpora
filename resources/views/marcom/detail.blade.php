    ...
    <div class="min-h-screen bg-white ">
        ...
        <div class="bg-white sm:p-8">
            <div class="container mx-auto pt-6 gap-6 flex w-full relative justify-center" x-data="{ openSection: 1, modalSubmit: false, modalBack: false, addressSame: false }">
                <form action="{{ route('marcom.store') }}" method="POST" enctype="multipart/form-data" class="form">
                @csrf
                ...
                <div class="form-container">
                    ...
                    <div x-show="openSection === 1" class="transition-all duration-300 ease-in-out transform"
                        ...
                        <div class="mb-4 p-4 rounded-xl shadow border-color-75 bg-white flex flex-col gap-6">
                            <div class="text-tosca text-base font-semibold leading-normal text-center">DATA MARCOM</div>
                            <div class="flex justify-between mb-4 flex-wrap">
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    ID Marcom <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="id" required placeholder="Masukkan Nama Bizmatch & Event/Advisory" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $marcom->id }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                        Tanggal Placement <span class="text-red-400">*</span>
                                    </label>
                                    <input type="date" name="marcom_date" required disabled
                                        ...
                                        placeholder="DD/MM/YYYY" value="{{ $marcom->marcom_date }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    Nama Bizmatch & Event/Advisory <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="bizmatch_event_name" required placeholder="Masukkan Nama Bizmatch & Event/Advisory" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $marcom->bizmatch_event_name }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    Video
                                    </label>
                                    <input type="text" name="video_link" placeholder="Masukkan Link Video" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $marcom->video_link }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    Picture <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="picture_link" required placeholder="Masukkan Link Picture" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $marcom->picture_link }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    Media Placement <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="content_category" required placeholder="Masukkan Media Placement" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $marcom->content_category }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    Campaign Owner <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="allocation" required placeholder="Masukkan Campaign Owner" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $marcom->allocation }}"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex justify-end gap-5 p-6 button-container">
                    <button type="button" @click="modalBack = true"
                        ...
                        <button type="button" onclick="window.location.href='/dashboard/marcom/{{ $marcom->id }}/edit'"
