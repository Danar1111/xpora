                            ...
                            <div class="flex justify-between mb-4 flex-wrap">
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 0.5rem;">
                                        <label><input type="radio" name="business_sector" value="Food and Beverage"> Food and Beverage</label>
                                        <label><input type="radio" name="business_sector" value="Fisheries"> Fisheries</label>
                                        <label><input type="radio" name="business_sector" value="Health and Beauty"> Health and Beauty</label>
                                        <label><input type="radio" name="business_sector" value="Footwear Headgear"> Footwear Headgear</label>
                                        <label><input type="radio" name="business_sector" value="Handicraft"> Handicraft</label>
                                        <label><input type="radio" name="business_sector" value="Stone Glass"> Stone Glass</label>
                                        <label><input type="radio" name="business_sector" value="Plastics Rubbers"> Plastics Rubbers</label>
                                        <label><input type="radio" name="business_sector" value="Textiles"> Textiles</label>
                                        <label><input type="radio" name="business_sector" value="Agriculture, Plantation, & Corp Product"> Agriculture, Plantation, & Corp Product</label>
                                        <label><input type="radio" name="business_sector" value="Animal And Animal Products"> Animal And Animal Products</label>
                                        <label><input type="radio" name="business_sector" value="Automotive and Transportation"> Automotive and Transportation</label>
                                        <label><input type="radio" name="business_sector" value="Raw Hides Skin Leather Furs"> Raw Hides Skin Leather Furs</label>
                                        <label><input type="radio" name="business_sector" value="Heavy Machinery & Equipment"> Heavy Machinery & Equipment</label>
                                        <label><input type="radio" name="business_sector" value="Electronics Household Appliances"> Electronics Household Appliances</label>
                                        <label><input type="radio" name="business_sector" value="Packaging & Office Supplies"> Packaging & Office Supplies</label>
                                        <label><input type="radio" name="business_sector" value="Other Services"> Other Services</label>
                                        <label><input type="radio" name="business_sector" value="Herb and Spices"> Herb and Spices</label>
                                        <label><input type="radio" name="business_sector" value="Chemicals Rubber Metallurgy"> Chemicals Rubber Metallurgy</label>
                                        <label><input type="radio" name="business_sector" value="Fashion and accessories"> Fashion and accessories</label>
                                        <label><input type="radio" name="business_sector" value="Furniture & Home Decor"> Furniture & Home Decor</label>
                                        <label><input type="radio" name="business_sector" value="Wood & Wood Processing"> Wood & Wood Processing</label>
                                        <label><input type="radio" name="business_sector" value="Mining and Mineral Products"> Mining and Mineral Products</label>
                                        <label><input type="radio" name="business_sector" value="Food Stuffs"> Food Stuffs</label>
                                    </div>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
