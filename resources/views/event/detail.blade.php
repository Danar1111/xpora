            ...
            <div class="container mx-auto pt-6 gap-6 flex w-full relative justify-center" x-data="{ openSection: 1, modalSubmit: false, modalBack: false, addressSame: false }">
                        ...
                        <div class="mb-4 p-4 rounded-xl shadow border-color-75 bg-white flex flex-col gap-6">
                            ...
                            <div class="flex justify-between mb-4 flex-wrap">
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    ID Event <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="document_no" required placeholder="Masukkan No. Dokumen" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $event->id }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                        Tanggal Mulai <span class="text-red-400">*</span>
                                    </label>
                                    <input type="date" name="start_date" required disabled
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="region" required placeholder="Masukkan Region" disabled
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <select id="country" name="country" disabled
                                        ...
                                        <option value="{{ $event->country }}" disabled selected>{{ $event->country }}</option>
                                    </select>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    ...
                                    <select id="city" name="city" disabled
                                        ...
                                        <option value="{{ $event->city }}" disabled selected>{{ $event->city }}</option>
                                    </select>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    ...
                                    <input type="text" name="event_category" required placeholder="Masukkan Kategori Event" disabled
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="business_sector" required placeholder="Masukkan Nama Produk / Komoditas" disabled
                                        autocomplete="off"
                                        class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full" value="{{ $event->business_sector }}"/>
                                </div>
                                <div class="width-100 md-mt-6 mb-6">
                                    <label class="block text-gray-700 text-sm font-semibold mb-2">
                                    Nama Produk / Komoditas <span class="text-red-400">*</span>
                                    </label>
                                    <input type="text" name="product_name" required placeholder="Masukkan Nama Produk / Komoditas" disabled
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="realized_budget" disabled
                                            class="outline-none focus:outline-none p-2 rounded-md bg-white border-color-75 w-full pl-11"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="event_document" required placeholder="Masukkan Link Google Drive Dokumen Event" disabled
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <textarea type="text" name="event_description" required placeholder="Masukkan Deskripsi Event" disabled
                                        autocomplete="off"
                ...
                <div class="flex justify-end gap-5 p-6 button-container">
                    <button type="button" @click="modalBack = true"
                        ...
                        <button type="button" onclick="window.location.href='/dashboard/event/{{ $event->id }}/edit'"
