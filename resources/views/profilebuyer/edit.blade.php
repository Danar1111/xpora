    ...
    <div class="min-h-screen bg-white ">
        ...
        <div class="bg-white sm:p-8">
            <div class="container mx-auto pt-6 gap-6 flex w-full relative justify-center" x-data="{ openSection: 1, modalSubmit: false, modalBack: false, addressSame: false }">
                <form action="{{ route('profilebuyer.update', $profileBuyer->id) }}" method="POST" enctype="multipart/form-data" class="form">
                @csrf
                        ...
                        <div class="mb-4 p-4 rounded-xl shadow border-color-75 bg-white flex flex-col gap-6">
                            ...
                            <div class="flex justify-between mb-4 flex-wrap">
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="event_id" required placeholder="Masukkan ID"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="event_name" required placeholder="Masukkan Nama Event & Business Matching"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="event_location" required placeholder="Masukkan Lokasi Business Matching & Event"
                                        autocomplete="off"
                        ...
                        <div class="mb-4 p-4 mt-8 rounded-xl shadow border-color-75 bg-white flex flex-col gap-6">
                            ...
                            <div class="flex justify-between mb-4 flex-wrap">
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="company_name" required placeholder="Masukkan Nama Perusahaan"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <select id="country" name="country"
                                        ...
                                        <option value="{{ $profileBuyer->country }}" selected>{{ $profileBuyer->country }}</option>
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <select id="city" name="city"
                                        ...
                                        <option value="{{ $profileBuyer->city }}" selected>{{ $profileBuyer->city }}</option>
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="sector" required placeholder="Masukkan Sector Perusahaan"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="interested_product" required placeholder="Masukkan Produk yang Diminati"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <input type="text" name="website" required placeholder="Masukkan Alamat Website"
                                        autocomplete="off"
                                ...
                                <div class="width-100 md-mt-6 mb-6">
                                    ...
                                    <textarea type="text" name="address" required placeholder="Masukkan Alamat Perusahaan"
                                        autocomplete="off"
