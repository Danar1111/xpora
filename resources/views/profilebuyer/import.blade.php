<x-app-layout title="Import Data Profile Buyer - Xpora">
            ...
            <div class="sm:max-w-lg w-full p-10 bg-white rounded-xl z-10 flex flex-wrap justify-center">
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-400 bg-neutral-100 rounded-md mb-4 p-2">Download template file sheet impor
                        <span class="font-bold text-orient-800"><a href="/assets/ProfileBuyerImportTemplate.xlsx" rel="noopener noreferrer">XLSX</a></span>
                    </p>
                </div>
                <form action="{{ route('profilebuyer.import-proses') }}" method="POST" enctype="multipart/form-data"
                    class="form">
                    @csrf
