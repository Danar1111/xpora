    ...
    <div class="py-6">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
                                            ...
                                            @foreach ($event as $u)
                                                <tr class="odd:bg-orange-50 odd:dark:bg-gray-900 even:bg-wite even:dark:bg-gray-800 border-b dark:border-gray-700">
                                                    ...
                                                    <td class="flex gap-4 p-4">
                                                        <a href="/dashboard/event/{{ $u->id }}" type="button"
                                                        ...
                                                        <form action="/dashboard/event/{{ $u->id }}" method="POST">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit"
            ...
            <div class="flex justify-between mt-5">
                <x-abutton url="{{ url('dashboard/event/daftar') }}" text="tambahkan"></x-abutton>

                <div class="flex gap-4">
                    <x-abutton url="{{ url('dashboard/event/import') }}" text="import data"></x-abutton>
                    <x-abutton url="{{ url('dashboard/event/export/excel') }}" text="EXPORT TO EXCEL"></x-abutton>
                    <x-abutton url="{{ url('dashboard/event/export/pdf') }}" text="EXPORT TO PDF"></x-abutton>
                </div>
            </div>
        </div>
    </div>
