    ...
    <div class="py-6">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
                                            ...
                                            @foreach ($release as $u)
                                                <tr class="odd:bg-orange-50 odd:dark:bg-gray-900 even:bg-wite even:dark:bg-gray-800 border-b dark:border-gray-700">
                                                    ...
                                                    <td
                                                        class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap dark:text-white" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 200px;">
                                                        <a
                                                            href="{{ $u->news_link }}" target="_blank">{{ $u->news_link }}</a>
                                                    </td>
                                                    <td class="flex gap-4 p-4">
                                                        <a href="/dashboard/release/{{ $u->id }}" type="button"
                                                        ...
                                                        <form action="/dashboard/release/{{ $u->id }}" method="POST">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit"
            ...
            <div class="flex justify-between mt-5">
                <x-abutton url="{{ url('dashboard/release/daftar') }}" text="tambahkan"></x-abutton>

                <div class="flex gap-4">
                    <x-abutton url="{{ url('dashboard/release/import') }}" text="import data"></x-abutton>
                    <x-abutton url="{{ url('dashboard/release/export/excel') }}" text="EXPORT TO EXCEL"></x-abutton>
                    <x-abutton url="{{ url('dashboard/release/export/pdf') }}" text="EXPORT TO PDF"></x-abutton>
                </div>
            </div>
        </div>
    </div>
