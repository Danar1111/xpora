    ...
    <div class="py-6">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
                                        ...
                                        <tbody>
                                            @foreach ($marcom as $u)
                                                <tr class="odd:bg-orange-50 odd:dark:bg-gray-900 even:bg-wite even:dark:bg-gray-800 border-b dark:border-gray-700">
                                                    ...
                                                    <td
                                                        class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap dark:text-white" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 200px;">
                                                        {{ $u->bizmatch_event_name }}
                                                    </td>
                                                    <td
                                                        class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap dark:text-white" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 200px;">
                                                        <a
                                                            href="{{ $u->news_link }}" target="_blank">{{ $u->video_link }}</a>
                                                    </td>
                                                    <td
                                                        class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap dark:text-white" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 200px;">
                                                        <a
                                                            href="{{ $u->news_link }}" target="_blank">{{ $u->picture_link }}</a>
                                                    </td>
                                                    <td
                                                        class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap dark:text-white" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 200px;">
                                                        {{ $u->content_category }}
                                                    ...
                                                    <td class="flex gap-4 p-4">
                                                        <a href="/dashboard/marcom/{{ $u->id }}" type="button"
                                                        ...
                                                        <form action="/dashboard/marcom/{{ $u->id }}" method="POST">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit"
            ...
            <div class="flex justify-between mt-5">
                <x-abutton url="{{ url('dashboard/marcom/daftar') }}" text="tambahkan"></x-abutton>

                <div class="flex gap-4">
                    <x-abutton url="{{ url('dashboard/marcom/import') }}" text="import data"></x-abutton>
                    <x-abutton url="{{ url('dashboard/marcom/export/excel') }}" text="EXPORT TO EXCEL"></x-abutton>
                    <x-abutton url="{{ url('dashboard/marcom/export/pdf') }}" text="EXPORT TO PDF"></x-abutton>
                </div>
            </div>
        </div>
    </div>
