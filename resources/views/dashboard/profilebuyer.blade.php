    ...
    <div class="py-6">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
                                            ...
                                            @foreach ($profileBuyer as $u)
                                                <tr class="odd:bg-orange-50 odd:dark:bg-gray-900 even:bg-wite even:dark:bg-gray-800 border-b dark:border-gray-700">
                                                    ...
                                                    <td
                                                        class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap dark:text-white" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 200px;">
                                                        <a
                                                            href="tel:+62{{ $u->phone_number }}" target="_blank">+62{{ $u->phone_number }}</a>
                                                    </td>
                                                    <td class="flex gap-4 p-4">
                                                        <a href="/dashboard/profilebuyer/{{ $u->id }}" type="button"
                                                        ...
                                                        <form action="/dashboard/profilebuyer/{{ $u->id }}" method="POST">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit"
            ...
            <div class="flex justify-between mt-5">
                <x-abutton url="{{ url('dashboard/profilebuyer/daftar') }}" text="Tambahkan"></x-abutton>

                <div class="flex gap-4">
                    <x-abutton url="{{ url('dashboard/profilebuyer/import') }}" text="import data"></x-abutton>
                    <x-abutton url="{{ url('dashboard/profilebuyer/export/excel') }}" text="EXPORT TO EXCEL"></x-abutton>
                    <x-abutton url="{{ url('dashboard/profilebuyer/export/pdf') }}" text="EXPORT TO PDF"></x-abutton>
                </div>
            </div>
        </div>
    </div>
